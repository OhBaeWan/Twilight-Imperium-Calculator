...
def main() -> None:
    ...
    runner_params.app_window_params.window_title = "Twilight Imperium Battle Calculator"
    ...
    demos = [
        DemoDetails("Tables", demo_implot)
    ]
    add_demo_dockable_window(demos[0].label, demos[0].demo_module)
